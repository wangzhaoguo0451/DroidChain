...
.field private static final q:Lgj;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/view/PagerTitleStrip;->q:Lgj;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v1, p0, v0}, Lgi;-><init>(Landroid/support/v4/view/PagerTitleStrip;B)V

    iput-object v1, p0, Landroid/support/v4/view/PagerTitleStrip;->l:Lgi;
...
.method private static setSingleLineAllCaps(Landroid/widget/TextView;)V
    ...
    .prologue
    .line 108
    sget-object v0, Landroid/support/v4/view/PagerTitleStrip;->q:Lgj;

    invoke-interface {v0, p0}, Lgj;->a(Landroid/widget/TextView;)V
...
.method public a(IFZ)V
    ...
    invoke-virtual {v2}, Landroid/support/v4/view/ViewPager;->getAdapter()Lgf;
    ...
    invoke-virtual {v0, v1, v2}, Landroid/support/v4/view/PagerTitleStrip;->a(ILgf;)V
...
.method public final a(ILgf;)V
    ...
    invoke-virtual {p2, v2}, Lgf;->b(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {p2, p1}, Lgf;->b(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {p2, v0}, Lgf;->b(I)Ljava/lang/CharSequence;
...
.method public final a(Lgf;Lgf;)V
    ...
    .line 317
    iget-object v0, p0, Landroid/support/v4/view/PagerTitleStrip;->l:Lgi;

    invoke-virtual {p1, v0}, Lgf;->b(Landroid/database/DataSetObserver;)V
    ...
    invoke-virtual {p2, v0}, Lgf;->a(Landroid/database/DataSetObserver;)V
    ...
    invoke-virtual {p0, v0, p2}, Landroid/support/v4/view/PagerTitleStrip;->a(ILgf;)V
...
.method protected onAttachedToWindow()V
    ...
    .line 253
    iget-object v2, p0, Landroid/support/v4/view/PagerTitleStrip;->l:Lgi;

    invoke-virtual {v0, v2}, Landroid/support/v4/view/ViewPager;->b(Lhw;)Lhw;

    .line 254
    iget-object v2, p0, Landroid/support/v4/view/PagerTitleStrip;->l:Lgi;

    invoke-virtual {v0, v2}, Landroid/support/v4/view/ViewPager;->setOnAdapterChangeListener(Lhv;)V
    ...
    :goto_0
    invoke-virtual {p0, v0, v1}, Landroid/support/v4/view/PagerTitleStrip;->a(Lgf;Lgf;)V
...
.method protected onDetachedFromWindow()V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/view/ViewPager;->b(Lhw;)Lhw;

    .line 265
    iget-object v0, p0, Landroid/support/v4/view/PagerTitleStrip;->a:Landroid/support/v4/view/ViewPager;

    invoke-virtual {v0, v1}, Landroid/support/v4/view/ViewPager;->setOnAdapterChangeListener(Lhv;)V
