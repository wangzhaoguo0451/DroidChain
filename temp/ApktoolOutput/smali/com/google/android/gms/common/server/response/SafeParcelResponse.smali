...
# static fields
.field public static final CREATOR:Lbam;


# instance fields
.field public final a:I

.field public final b:Lcom/google/android/gms/common/server/response/FieldMappingDictionary;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->CREATOR:Lbam;
...
.method public constructor <init>(ILandroid/os/Parcel;Lcom/google/android/gms/common/server/response/FieldMappingDictionary;)V
    ...
    iput-object v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->c:Landroid/os/Parcel;

    iput-object p3, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->b:Lcom/google/android/gms/common/server/response/FieldMappingDictionary;

    iget-object v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->b:Lcom/google/android/gms/common/server/response/FieldMappingDictionary;

    if-nez v0, :cond_0

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->d:Ljava/lang/String;

    :goto_0
    const/4 v0, 0x2

    iput v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->e:I
...
.method private static a(Ljava/lang/StringBuilder;ILjava/lang/Object;)V
    ...
    invoke-static {v1}, Lbkl;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p2}, Ld;->b([B)Ljava/lang/String;
    ...
    invoke-static {p2}, Ld;->c([B)Ljava/lang/String;
    ...
    invoke-static {p0, p2}, Ld;->a(Ljava/lang/StringBuilder;Ljava/util/HashMap;)V
...
.method private a(Ljava/lang/StringBuilder;Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;Landroid/os/Parcel;I)V
    ...
    :pswitch_0
    invoke-static {p3, p4}, Ld;->a(Landroid/os/Parcel;I)I
    ...
    :goto_2
    invoke-static {p1, v0}, Ld;->a(Ljava/lang/StringBuilder;[Ljava/lang/Object;)V
    ...
    :goto_6
    invoke-static {p1, v0}, Ld;->a(Ljava/lang/StringBuilder;[J)V
    ...
    :goto_7
    invoke-static {p1, v0}, Ld;->a(Ljava/lang/StringBuilder;[F)V
    ...
    :goto_8
    invoke-static {p1, v0}, Ld;->a(Ljava/lang/StringBuilder;[D)V
    ...
    :pswitch_5
    invoke-static {p3, p4}, Ld;->n(Landroid/os/Parcel;I)[Ljava/math/BigDecimal;
    ...
    :goto_9
    invoke-static {p1, v0}, Ld;->a(Ljava/lang/StringBuilder;[Z)V
    ...
    :pswitch_7
    invoke-static {p3, p4}, Ld;->o(Landroid/os/Parcel;I)[Ljava/lang/String;

    move-result-object v0

    invoke-static {p1, v0}, Ld;->a(Ljava/lang/StringBuilder;[Ljava/lang/String;)V
    ...
    :pswitch_9
    invoke-static {p3, p4}, Ld;->q(Landroid/os/Parcel;I)[Landroid/os/Parcel;
    ...
    invoke-virtual {p2}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->b()Ljava/util/Map;
    ...
    :pswitch_a
    invoke-static {p3, p4}, Ld;->d(Landroid/os/Parcel;I)I
    ...
    :pswitch_b
    invoke-static {p3, p4}, Ld;->f(Landroid/os/Parcel;I)Ljava/math/BigInteger;
    ...
    :pswitch_c
    invoke-static {p3, p4}, Ld;->e(Landroid/os/Parcel;I)J
    ...
    :pswitch_d
    invoke-static {p3, p4}, Ld;->g(Landroid/os/Parcel;I)F
    ...
    :pswitch_e
    invoke-static {p3, p4}, Ld;->h(Landroid/os/Parcel;I)D
    ...
    :pswitch_f
    invoke-static {p3, p4}, Ld;->i(Landroid/os/Parcel;I)Ljava/math/BigDecimal;
    ...
    :pswitch_10
    invoke-static {p3, p4}, Ld;->c(Landroid/os/Parcel;I)Z
    ...
    :pswitch_11
    invoke-static {p3, p4}, Ld;->j(Landroid/os/Parcel;I)Ljava/lang/String;
    ...
    :pswitch_12
    invoke-static {p3, p4}, Ld;->m(Landroid/os/Parcel;I)[B
    ...
    invoke-static {v0}, Ld;->c([B)Ljava/lang/String;
    ...
    :pswitch_14
    invoke-static {p3, p4}, Ld;->l(Landroid/os/Parcel;I)Landroid/os/Bundle;
    ...
    :pswitch_15
    invoke-static {p3, p4}, Ld;->p(Landroid/os/Parcel;I)Landroid/os/Parcel;
...
.method private a(Ljava/lang/StringBuilder;Ljava/util/Map;Landroid/os/Parcel;)V
    ...
    invoke-static {p3}, Ld;->a(Landroid/os/Parcel;)I
    ...
    iget-object v1, v0, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->j:Lbah;
    ...
    :pswitch_0
    invoke-static {p3, v6}, Ld;->d(Landroid/os/Parcel;I)I
    ...
    :pswitch_1
    invoke-static {p3, v6}, Ld;->f(Landroid/os/Parcel;I)Ljava/math/BigInteger;
    ...
    :pswitch_2
    invoke-static {p3, v6}, Ld;->e(Landroid/os/Parcel;I)J
    ...
    :pswitch_3
    invoke-static {p3, v6}, Ld;->g(Landroid/os/Parcel;I)F
    ...
    :pswitch_4
    invoke-static {p3, v6}, Ld;->h(Landroid/os/Parcel;I)D
    ...
    :pswitch_5
    invoke-static {p3, v6}, Ld;->i(Landroid/os/Parcel;I)Ljava/math/BigDecimal;
    ...
    :pswitch_6
    invoke-static {p3, v6}, Ld;->c(Landroid/os/Parcel;I)Z
    ...
    :pswitch_7
    invoke-static {p3, v6}, Ld;->j(Landroid/os/Parcel;I)Ljava/lang/String;
    ...
    :pswitch_8
    invoke-static {p3, v6}, Ld;->m(Landroid/os/Parcel;I)[B
    ...
    :pswitch_9
    invoke-static {p3, v6}, Ld;->l(Landroid/os/Parcel;I)Landroid/os/Bundle;
...
.method public final a()Ljava/util/Map;
    ...
    iget-object v1, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->d:Ljava/lang/String;
...
.method public final d()Landroid/os/Parcel;
    ...
    iget v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->e:I
    ...
    invoke-static {v0, v1}, Ld;->r(Landroid/os/Parcel;I)I
    ...
    invoke-static {v0, v1}, Ld;->s(Landroid/os/Parcel;I)V
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->b:Lcom/google/android/gms/common/server/response/FieldMappingDictionary;

    iget-object v3, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->d:Ljava/lang/String;
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    invoke-static {p0, p1, p2}, Lbam;->a(Lcom/google/android/gms/common/server/response/SafeParcelResponse;Landroid/os/Parcel;I)V
