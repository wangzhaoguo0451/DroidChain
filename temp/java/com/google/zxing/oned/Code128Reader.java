                ...
                while(j1 < i) 
                {
                    ...
                    } else
                    {
                        if(k == i1 - 1)
                        {
                            ...
                            {
                                int k2 = patternMatchVariance(ai, CODE_PATTERNS[i2], 179);
                                if(k2 < k1)
                                {
                                    k1 = k2;
                                    l1 = i2;
                            ...
                            if(l1 >= 0 && bitarray.isRange(Math.max(0, l - (j1 - l) / 2), l, false))
                            {
                                int ai1[] = new int[3];
                                ai1[0] = l;
                                ai1[1] = j1;
...
_L7:
        j1;
        JVM INSTR tableswitch 103 105: default 228
    //                   103 298
    //                   104 298
    //                   105 298;
...
_L8:
        byte0;
        JVM INSTR tableswitch 99 101: default 256
    //                   99 573
    //                   100 449
    //                   101 302;
...
_L15:
_L12:
        if(j1 >= 96) goto _L18; else goto _L17
_L17:
        stringbuffer.append((char)(j1 + 32));
          goto _L16
_L18:
...
_L11:
        ...
        } else
        {
          ...
          goto _L16
        if(true) goto _L16; else goto _L20
_L20:
        if(true) goto _L14; else goto _L21
_L21:
_L6:
        int i2;
        for(i2 = bitarray.getSize(); l < i2 && bitarray.get(l); l++);
        int j2 = Math.min(i2, l + (l - k) / 2);
        if(!bitarray.isRange(l, j2, false))
            throw NotFoundException.getNotFoundInstance();
        if((k1 - l1 * i1) % 103 != i1)
        ...
        if(k2 > 0 && flag2)
            if(byte0 == 99)
                stringbuffer.delete(k2 - 2, k2);
            else
                stringbuffer.delete(k2 - 1, k2);
