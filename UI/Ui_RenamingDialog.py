...
class Ui_RenamingDialog(object):
    ...
    def retranslateUi(self, RenamingDialog):
        RenamingDialog.setWindowTitle(QtGui.QApplication.translate("RenamingDialog", "对话框", None, QtGui.QApplication.UnicodeUTF8))
        self.label.setText(QtGui.QApplication.translate("RenamingDialog", "重命名", None, QtGui.QApplication.UnicodeUTF8))
        self.label_2.setText(QtGui.QApplication.translate("RenamingDialog", "至", None, QtGui.QApplication.UnicodeUTF8))
        self.pushButton_ok.setText(QtGui.QApplication.translate("RenamingDialog", "确认", None, QtGui.QApplication.UnicodeUTF8))
        self.pushButton_cancel.setText(QtGui.QApplication.translate("RenamingDialog", "取消", None, QtGui.QApplication.UnicodeUTF8))
"""
from PyQt4 import QtCore, QtGui
