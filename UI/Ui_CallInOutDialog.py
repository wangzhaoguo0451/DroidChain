...
class Ui_CallInOutDialog(object):
    def setupUi(self, CallInOutDialog):
        ...
        self.label_5.setGeometry(QtCore.QRect(20, 50, 571, 17))
        self.label_5.setObjectName(_fromUtf8("label_5"))
        self.layoutWidget = QtGui.QWidget(CallInOutDialog)
        self.layoutWidget.setGeometry(QtCore.QRect(20, 90, 551, 29))
        ...
        self.layoutWidget1 = QtGui.QWidget(CallInOutDialog)
        self.layoutWidget1.setGeometry(QtCore.QRect(20, 140, 551, 29))
        ...
        self.lineEdit_method = QtGui.QLineEdit(self.layoutWidget1)
        self.lineEdit_method.setObjectName(_fromUtf8("lineEdit_method"))
        self.horizontalLayout_2.addWidget(self.lineEdit_method)
        self.layoutWidget2 = QtGui.QWidget(CallInOutDialog)
        self.layoutWidget2.setGeometry(QtCore.QRect(20, 190, 551, 29))
        ...
        self.lineEdit_descriptor = QtGui.QLineEdit(self.layoutWidget2)
        ...
        self.layoutWidget3 = QtGui.QWidget(CallInOutDialog)
        self.layoutWidget3.setGeometry(QtCore.QRect(200, 240, 231, 24))
        self.layoutWidget3.setObjectName(_fromUtf8("layoutWidget3"))
        self.horizontalLayout_4 = QtGui.QHBoxLayout(self.layoutWidget3)
        self.horizontalLayout_4.setMargin(0)
        self.horizontalLayout_4.setObjectName(_fromUtf8("horizontalLayout_4"))
        self.checkBox_in = QtGui.QCheckBox(self.layoutWidget3)
        ...
        self.checkBox_out = QtGui.QCheckBox(self.layoutWidget3)
        ...
        self.layoutWidget4 = QtGui.QWidget(CallInOutDialog)
        self.layoutWidget4.setGeometry(QtCore.QRect(50, 290, 461, 29))
        self.layoutWidget4.setObjectName(_fromUtf8("layoutWidget4"))
        self.horizontalLayout_5 = QtGui.QHBoxLayout(self.layoutWidget4)
        self.horizontalLayout_5.setMargin(0)
        self.horizontalLayout_5.setObjectName(_fromUtf8("horizontalLayout_5"))
        self.pushButton_ok = QtGui.QPushButton(self.layoutWidget4)
        self.pushButton_ok.setMaximumSize(QtCore.QSize(85, 27))
        self.pushButton_ok.setObjectName(_fromUtf8("pushButton_ok"))
        self.horizontalLayout_5.addWidget(self.pushButton_ok)
        self.pushButton_cancel = QtGui.QPushButton(self.layoutWidget4)
    ...
    def retranslateUi(self, CallInOutDialog):
        CallInOutDialog.setWindowTitle(QtGui.QApplication.translate("CallInOutDialog", "Call in/out 对话框", None, QtGui.QApplication.UnicodeUTF8))
        self.label.setText(QtGui.QApplication.translate("CallInOutDialog", "请输入方法来获取call in/out", None, QtGui.QApplication.UnicodeUTF8))
        self.label_5.setText(QtGui.QApplication.translate("CallInOutDialog", "例如:Lcom/dlp/SMSReplicatorSecret/ShadyDB; (Landroid/content/Context;)V,<init>", None, QtGui.QApplication.UnicodeUTF8))
        self.label_2.setText(QtGui.QApplication.translate("CallInOutDialog", "类名:  ", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.label_3.setText(QtGui.QApplication.translate("CallInOutDialog", "方法名:", None, QtGui.QApplication.UnicodeUTF8))
        self.lineEdit_method.setText(QtGui.QApplication.translate("CallInOutDialog", "<init>", None, QtGui.QApplication.UnicodeUTF8))
        self.label_4.setText(QtGui.QApplication.translate("CallInOutDialog", "描述符:    ", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.pushButton_ok.setText(QtGui.QApplication.translate("CallInOutDialog", "确认", None, QtGui.QApplication.UnicodeUTF8))
        self.pushButton_cancel.setText(QtGui.QApplication.translate("CallInOutDialog", "取消", None, QtGui.QApplication.UnicodeUTF8))
"""
from PyQt4 import QtCore, QtGui
