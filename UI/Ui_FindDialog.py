...
class Ui_FindDialog(object):
    def setupUi(self, FindDialog):
        ...
        self.checkBox_1.setGeometry(QtCore.QRect(30, 100, 81, 22))
    ...
    def retranslateUi(self, FindDialog):
        FindDialog.setWindowTitle(QtGui.QApplication.translate("FindDialog", "查找", None, QtGui.QApplication.UnicodeUTF8))
        self.label.setText(QtGui.QApplication.translate("FindDialog", "搜索", None, QtGui.QApplication.UnicodeUTF8))
        self.checkBox_1.setText(QtGui.QApplication.translate("FindDialog", "匹配情况", None, QtGui.QApplication.UnicodeUTF8))
        self.checkBox_2.setText(QtGui.QApplication.translate("FindDialog", "仅匹配整个单词", None, QtGui.QApplication.UnicodeUTF8))
        self.checkBox_3.setText(QtGui.QApplication.translate("FindDialog", "向后搜索", None, QtGui.QApplication.UnicodeUTF8))
        self.checkBox_4.setText(QtGui.QApplication.translate("FindDialog", "环绕搜索", None, QtGui.QApplication.UnicodeUTF8))
        self.pushButton_close.setText(QtGui.QApplication.translate("FindDialog", "关闭", None, QtGui.QApplication.UnicodeUTF8))
        self.pushButton_find.setText(QtGui.QApplication.translate("FindDialog", "查找", None, QtGui.QApplication.UnicodeUTF8))
"""
from PyQt4 import QtCore, QtGui
