...
class Ui_inputDialog_dalvik(object):
    ...
    def retranslateUi(self, inputDialog_dalvik):
        inputDialog_dalvik.setWindowTitle(QtGui.QApplication.translate("inputDialog_dalvik", "修改的Dalvik代码", None, QtGui.QApplication.UnicodeUTF8))
        self.pushButton_ok_dalvik.setText(QtGui.QApplication.translate("inputDialog_dalvik", "确认", None, QtGui.QApplication.UnicodeUTF8))
        self.pushButton_cancel_dalvik.setText(QtGui.QApplication.translate("inputDialog_dalvik", "取消", None, QtGui.QApplication.UnicodeUTF8))
"""
