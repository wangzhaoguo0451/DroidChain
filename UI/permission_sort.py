...
class permission_sort(object):
    def setupUi(self, permission_sort):
        permission_sort.setObjectName(_fromUtf8("permission_sort"))
        permission_sort.resize(400, 405)
        self.layoutWidget = QtGui.QWidget(permission_sort)
        ...
        self.layoutWidget_2 = QtGui.QWidget(permission_sort)
...
#         self.gridLayout.addWidget(self.checkBox_manifest, 8, 1, 1, 1)
       ...
       # QtCore.QMetaObject.connectSlotsByName(AutoConfigurationDialog)
        self.retranslateUi(permission_sort)
        QtCore.QObject.connect(self.pushButton_ok, QtCore.SIGNAL(_fromUtf8("clicked(bool)")), permission_sort.close)
        QtCore.QObject.connect(self.pushButton_cancel, QtCore.SIGNAL(_fromUtf8("clicked(bool)")), permission_sort.close)
        QtCore.QMetaObject.connectSlotsByName(permission_sort)

    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(QtGui.QApplication.translate("permission_sort", "权限组合分析(自动化分析)", None, QtGui.QApplication.UnicodeUTF8))
        self.pushButton_ok.setText(QtGui.QApplication.translate("permission_sort", "确认", None, QtGui.QApplication.UnicodeUTF8))
        self.pushButton_cancel.setText(QtGui.QApplication.translate("permission_sort", "取消", None, QtGui.QApplication.UnicodeUTF8))
        self.label.setText(QtGui.QApplication.translate("permission_sort", "权限组合-IP-URL", None, QtGui.QApplication.UnicodeUTF8))
        self.checkBox_cfg.setText(QtGui.QApplication.translate("permission_sort", "打开", None, QtGui.QApplication.UnicodeUTF8))
        self.label_2.setText(QtGui.QApplication.translate("permission_sort", "API分析", None, QtGui.QApplication.UnicodeUTF8))
        self.checkBox_dalvik.setText(QtGui.QApplication.translate("permission_sort", "打开", None, QtGui.QApplication.UnicodeUTF8))
        self.label_3.setText(QtGui.QApplication.translate("permission_sort", "3", None, QtGui.QApplication.UnicodeUTF8))
        self.checkBox_javacode.setText(QtGui.QApplication.translate("permission_sort", "打开", None, QtGui.QApplication.UnicodeUTF8))
        self.label_4.setText(QtGui.QApplication.translate("permission_sort", "4", None, QtGui.QApplication.UnicodeUTF8))
        self.checkBox_bytecode.setText(QtGui.QApplication.translate("permission_sort", "打开", None, QtGui.QApplication.UnicodeUTF8))
        self.label_5.setText(QtGui.QApplication.translate("permission_sort", "5", None, QtGui.QApplication.UnicodeUTF8))
        self.checkBox_smalicode.setText(QtGui.QApplication.translate("permission_sort", "打开", None, QtGui.QApplication.UnicodeUTF8))
        self.label_6.setText(QtGui.QApplication.translate("permission_sort", "6", None, QtGui.QApplication.UnicodeUTF8))
        self.checkBox_callin.setText(QtGui.QApplication.translate("permission_sort", "打开", None, QtGui.QApplication.UnicodeUTF8))
#         self.label_9.setText(QtGui.QApplication.translate("AutoConfigurationDialog", "G", None, QtGui.QApplication.UnicodeUTF8))
...
if __name__ == "__main__":
    ...
    Permission_sort = QtGui.QDialog()
    ui = permission_sort()
    ui.setupUi(Permission_sort)
    Permission_sort.show()
    sys.exit(app.exec_())